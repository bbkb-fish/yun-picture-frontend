  ...
  <div class="member-form-wrap">
    <div class="member-form-inner">
      ...
      >
        ...
        <!-- 记住我 + 忘记密码 -->
        <div class="member-remember">
          <el-checkbox v-model="remember" label="记住我的登录状态" />
          <a class="member-form-forgot" href="javascript:void(0)">忘记密码？</a>
        </div>
...
import { userLoginUsingPost } from '@/services/api/userController'
...
.member-remember :deep(.el-checkbox__label) {
  color: #666;
  font-size: 14px;
  font-weight: 400;
}

.member-remember :deep(.el-checkbox__inner) {
  border-radius: 2px;
  border-color: #bbb;
}

.member-remember :deep(.el-checkbox__input.is-checked .el-checkbox__inner) {
